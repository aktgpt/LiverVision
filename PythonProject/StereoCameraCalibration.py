...
class StereoCalibration(object):
    ...
    def read_images(self, cal_path):
        ...
        for i, fname in enumerate(images_right):
            ...
            if ret_r is True and ret_r is True:
        ...
        self.stereo_model = self.getProjectionMatrices()
    ...
    def getProjectionMatrices(self):
        ...
        p = cv2.stereoRectify(cameraModel['M1'], cameraModel['dist1'], cameraModel['M2'], cameraModel['dist2'],
                                   self.img_shape, cameraModel['R'], cameraModel['T'])
        stereoModel = dict([('R1', p[0]), ('R2', p[1]), ('P1', p[2]), ('P2', p[3])])
        return stereoModel

    def saveCalibrationParameters(self):
        np.savez("StereoParameters", FundamentalMatrix=self.camera_model['F'], LeftProjectionMatrix=self.stereo_model['P1'],
                 RightProjectionMatrix=self.stereo_model['P2'])
